...
search_space = SearchSpace(
    parameters=[
        RangeParameter(
            name="excite", lower=1, upper=5, parameter_type=ParameterType.FLOAT
        ),
        FixedParameter(
            name="neurogenesis", value=8, parameter_type=ParameterType.INT
        ),
        FixedParameter(
            name="frequency", value=642, parameter_type=ParameterType.INT
        ),
        FixedParameter(
            name="turnover", value=1., parameter_type=ParameterType.FLOAT
        ),
        FixedParameter(
            name="end_neurogenesis", value=11, parameter_type=ParameterType.INT
        ),
        FixedParameter(
...
if __name__ == "__main__":
    ...
    save_name = str(EXP_RESULTS / f"exp-bo-ngn-excite-{START_TIME}.json") #TODO
