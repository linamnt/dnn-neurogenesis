...
group_config = {
    "Neurogenesis": {
        ...
        "optimizer_args": {"lr": 0.02}#, "momentum": 0.95},
    },
    "Control": {
        "training_args": {
            "opt_fn": optim.SGD,
    ...
    "L2": {
        ...
        "optimizer_args": {"lr": LR, "weight_decay": 0.001,}# 'momentum': 0.8'},
    },
...
data_loader = mlp.load_data(
    batch_size=BATCH_SIZE, data_dir=DATA_DIR, fashion=True, num_workers=16, split=0.85
)
